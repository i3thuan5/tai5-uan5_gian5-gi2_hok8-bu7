...
class 合成服務單元試驗(TestCase):
    ...
    def test_正規化翻譯支援腔口(self):
        服務功能 = HTS服務(全部合成母語模型={'臺語': {}, '客話': {}, 'Kaxabu': {}})
    ...
    @patch('臺灣言語服務.HTS服務.HTS服務._語音合成實作')
    def test_正規化翻譯get(self, 實作mock):
        母語模型 = {
            '模型': None,
            '拼音': None,
            '變調': None,
        }
        服務功能 = HTS服務(全部合成母語模型={'母語': 母語模型})
    ...
    @patch('臺灣言語服務.HTS服務.HTS服務._語音合成實作')
    def test_正規化翻譯post(self, 實作mock):
        母語模型 = {
            '模型': None,
            '拼音': None,
            '變調': None,
